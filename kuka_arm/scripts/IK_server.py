...
class Kuka_KR210:
    ...
    def get_R(n, t1=None, t2=None, t3=None, t4=None, t5=None, t6=None):
        # Get rotation matrix for different arm frames, n=1 to 8
        r = self.get_T(n, t1=t1, t2=td2, t3=t3, t4=t4, t5=t5, t6=t6)
        return r[:3,:3]

    def get_T(n=1, t1=None, t2=None, t3=None, t4=None, t5=None, t6=None):
