...
def handle_calculate_IK(req):
    ...
    if len(req.poses) < 1:
        ...
        for x in xrange(0, len(req.poses)):
            ...
            theta1, theta2, theta3, theta4, theta5, theta6 = do_IK(px, py, pz, roll, pitch, yaw)
...
def do_test():
    ...
    if 1:
        ...
        theta1, theta2, theta3, theta4, theta5, theta6 = do_IK(px, py, pz, roll, pitch, yaw, debug=True)
    if 1:
...
def do_IK(px, py, pz, roll, pitch, yaw, debug=False):
